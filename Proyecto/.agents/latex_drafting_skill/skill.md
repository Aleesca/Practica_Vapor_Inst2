...
## Directrices de Estilo de Redacción (según Planning/instrucciones.md)
*   **Tono:** Formal, académico y técnico (propio de un proyecto de fin de grado).
*   **Voz:** Uso preferente de la pasiva refleja ('se ha calculado', 'se observa') en lugar de la primera persona.
*   **Terminología:** Seguir la terminología exacta de la normativa RITE y las guías del IDAE.
*   **Estructura de Párrafo:** Predominio de la prosa escrita, utilizando bullet points solo cuando sea estrictamente necesario. Párrafos explicativos pero concisos, evitando frases excesivamente largas.
