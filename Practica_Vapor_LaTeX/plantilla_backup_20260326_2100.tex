...
Las pérdidas de carga en accesorios se consideran mediante las longitudes equivalentes expresadas en la \tabref{tab:longitudes-equivalentes}.
...
\begin{table}[H]
	...
	\begin{tabular}{lccccccc}
		...
		P-C1        & 88,189                         & 2                  & 1                  & 0                   & 60                                & 9,24                         & 97,429                            \\
...
\begin{figure}[H]
	...
	\caption{Cálculos de pérdida de carga para el Tramo 2 (P-C1)}
	\label{fig:calculos-tramo2}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.55\textwidth]{Figuras/dibujos_tramos/Vapor_TR2_P-C1.pdf}
	\caption{Esquema del Tramo 2 (P-C1) con disposición enterrada}
