...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 1 (Caldera-P). Elaboración grupal. \textit{Nota: Esta hoja de cálculo también se incluye completa en la \autoref{fig:anejo3-vapor-tr1} del \anexoref{anexo:calculos} para referencia detallada.}}
...
\begin{figure}[H]
	...
	\caption{Croquis del Tramo 1 (Caldera-P). Elaboración grupal. \textit{Nota: Este diagrama también se incluye en la \autoref{fig:anejo2-vapor-tr1} del \anexoref{anexo:diagramas} para referencia detallada.}}
...
\begin{table}[H]
	...
	\begin{tabular}{lc}
		...
		\textbf{Parámetro} & \textbf{Valor} \\
		\midrule
		Velocidad real (m/s)     & 18{,}93        \\
		Pérdida de carga (bar)   & 0{,}24         \\
		Presión de entrada (bar(g)) & 9{,}058        \\
		Presión de salida (bar(g))  & 8{,}818        \\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{lc}
		...
		Protección mecánica (cm)            & Losa HA-25, 10                     \\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{lcc}
		...
		Entalpía vap. sat. a $P_2$ (kJ/kg) & $h_{v,P_2}$      & 2.738{,}09      \\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{lc}
		...
		\midrule
		Condensado total       & 5.403{,}95              \\
		Vapor flash (7{,}45\%) & 402{,}54                \\
		Condensado líquido     & 5.001{,}41              \\
		\bottomrule
	\end{tabular}
\end{table}
...
La \tabref{tab:dimensionado-condensados} presenta los resultados del dimensionado hidráulico para cada tramo de la red de condensados. Los esquemas detallados de cada tramo se incluyen en el \anexoref{anexo:diagramas} (Figuras \ref{fig:anejo2-condensados-tr1} a \ref{fig:anejo2-condensados-tr7}), y las hojas de cálculo correspondientes en el \anexoref{anexo:calculos} (Figuras \ref{fig:anejo3-condensados-tr1} a \ref{fig:anejo3-condensados-tr7}).
...
\begin{table}[htbp]
	...
	\small
	\setlength{\tabcolsep}{3pt}
	\caption{Dimensionado completo del aislamiento térmico para la red de distribución de vapor. Fuente: Elaboración grupal.}
...
\begin{table}[htbp]
	...
	\small
	\setlength{\tabcolsep}{3pt}
	\caption{Dimensionado completo del aislamiento térmico para la red de retorno de condensados. Fuente: Elaboración grupal.}
