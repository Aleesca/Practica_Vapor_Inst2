...
\begin{figure}[H]
	...
	\caption{Determinación de la presión de diseño de la caldera}
...
La \textbf{rugosidad absoluta} ($\varepsilon$) del acero comercial nuevo se sitúa en torno a 0,02~mm. Para los cálculos de la presente instalación se adopta el valor:
...
Los diámetros normalizados según la norma DIN~2448 serán utilizados para la selección de tuberías comerciales en cada tramo de la instalación.
...
La \tabref{tab:resumen-longitudes-calculo} presenta el inventario de accesorios identificados en cada tramo y resume el cálculo de las longitudes equivalentes resultantes. En los tramos que no presentan accesorios significativos (Caldera-P, S-C$_2$ y T-C$_3$), se ha aplicado un criterio simplificado mayorando la longitud real en un 20\% para contabilizar uniones y pequeños elementos. Para el resto de tramos, la longitud equivalente se ha determinado mediante la suma de los coeficientes $L_e/D$ y el diámetro de tanteo correspondiente.

\begin{table}[H]
	\centering
	\small
	\setlength{\tabcolsep}{3pt}
	\caption{Inventario de accesorios y resumen de longitudes de cálculo para la red de vapor}
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{lcccccccl}
			...
			S-C$_2$        & 25                             & 0                  & 0                  & 0                   & ---                             & 5,00                         & 30,00                          & Criterio 20\%   \\
			S-T            & 60                             & 0                  & 1                  & 1                   & 120                             & 7,50                         & 78,00                          & $L_e/D$         \\
			T-C$_3$        & 15                             & 0                  & 0                  & 0                   & ---                             & 3,00                         & 18,00                          & Criterio 20\%   \\
			T-C$_4$        & 45                             & 2                  & 1                  & 0                   & 100                             & 12,40                        & 57,40                          & $L_e/D$         \\
			\midrule
...
Consultando los diámetros normalizados según DIN~2448, se selecciona el diámetro comercial inmediatamente superior: \textbf{DN~150 Schedule~80}.
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 1 (Caldera-P). Elaboración grupal. \textit{Nota: Esta hoja de cálculo también se incluye completa en la \autoref{fig:anejo3-vapor-tr1} del \nameref{anexo:calculos} para referencia.}}
...
\begin{figure}[H]
	...
	\caption{Croquis del Tramo 1 (Caldera-P). Elaboración grupal. \textit{Nota: Este diagrama también se incluye en la \autoref{fig:anejo2-vapor-tr1} del \nameref{anexo:diagramas} para referencia.}}
...
\begin{table}[H]
	\centering
	\caption{Datos de partida del Tramo 2 (P-C1)}
...
El consumidor C1 requiere una presión de trabajo de 4~bar(g) con un caudal de 679~kg/h. La presión disponible a la salida del tramo es de 8{,}818~bar(g), lo que proporciona un margen de +4{,}818~bar respecto a la presión requerida. Este exceso de presión se regulará mediante una válvula reductora de presión instalada en la acometida al consumidor.
...
\begin{table}[H]
	\centering
	\caption{Resumen de resultados del Tramo 2 (P-C1)}
	...
	\begin{tabular}{lcc}
		...
		Presión salida (C1)       & 8{,}818                                   & bar(g)          \\
		\bottomrule
	\end{tabular}
\end{table}

Los cálculos detallados de pérdida de carga se muestran en la \autoref{fig:anejo3-vapor-tr2} del \nameref{anexo:calculos}, mientras que el esquema del tramo con sus cotas y accesorios se presenta en la \autoref{fig:anejo2-vapor-tr2} del \nameref{anexo:diagramas}.
...
La velocidad de 20{,}28~m/s está dentro del rango objetivo de diseño. Los cálculos detallados se muestran en la \autoref{fig:anejo3-vapor-tr3} del \nameref{anexo:calculos}, y el esquema del tramo en la \autoref{fig:anejo2-vapor-tr3} del \nameref{anexo:diagramas}.
...
La presión de salida de 8{,}83~bar(g) supera ampliamente la presión requerida por C$_2$ (7~bar(g)), proporcionando un margen de 1{,}83~bar. Los cálculos detallados se muestran en la \autoref{fig:anejo3-vapor-tr4} del \nameref{anexo:calculos}, y el esquema del tramo en la \autoref{fig:anejo2-vapor-tr4} del \nameref{anexo:diagramas}.
...
Los tres tramos mantienen velocidades muy próximas al objetivo de diseño (20~m/s), confirmando la coherencia del dimensionado. Las hojas de cálculo detalladas se presentan en las Figuras \ref{fig:anejo3-vapor-tr5}, \ref{fig:anejo3-vapor-tr6} y \ref{fig:anejo3-vapor-tr7} del \nameref{anexo:calculos}, y los esquemas correspondientes en las Figuras \ref{fig:anejo2-vapor-tr5}, \ref{fig:anejo2-vapor-tr6} y \ref{fig:anejo2-vapor-tr7} del \nameref{anexo:diagramas}.
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{lcccccc}
			\toprule
			\textbf{Tramo} & \textbf{Tubería} & \textbf{$D_{int}$} & \textbf{$L_{\text{calc}}$} & \textbf{$\dot{m}$} & \textbf{$v$} & \textbf{$\Delta P$} \\
			               &                  & (mm)               & (m)                        & (kg/h)             & (m/s)        & (bar)               \\
			\midrule
			1: Caldera-P   & Sch.80 DN~150    & 146{,}4            & 15{,}29                    & 5400               & 19{,}17      & 0{,}01              \\
			2: P-C1        & Sch.160 DN~80    & 66{,}6             & 97{,}43                    & 679                & 18{,}93      & 0{,}24              \\
...
\begin{table}[H]
	...
	\begin{tabular}{lcc}
		...
		\textbf{Recorrido}          & \textbf{$\Delta P_{total}$}                  & \textbf{Criterio $<$ 1 bar} \\
		                            & (bar)                                        &                             \\
		\midrule
		Caldera $\rightarrow$ C1    & $0{,}01 + 0{,}24 = 0{,}25$                   & \checkmark                  \\
...
\begin{equation}
	\begin{split}
		\%v_f & = \frac{763{,}05 - 604{,}67}{2.738{,}09 - 604{,}67} \times 100 \\
		      & = \frac{158{,}38}{2.133{,}42} \times 100 = 7{,}45\%
	\end{split}
...
\begin{itemize}[noitemsep]
	...
	\item C1, C$_2$, C$_3$, C$_4$ = Consumidores
\end{itemize}

\paragraph{Resultados del dimensionado}

La \tabref{tab:dimensionado-condensados} presenta los resultados del dimensionado hidráulico para cada tramo de la red de condensados. Los esquemas detallados de cada tramo se incluyen en el \nameref{anexo:diagramas} (Figuras \ref{fig:anejo2-condensados-tr1} a \ref{fig:anejo2-condensados-tr7}), y las hojas de cálculo correspondientes en el \nameref{anexo:calculos} (Figuras \ref{fig:anejo3-condensados-tr1} a \ref{fig:anejo3-condensados-tr7}).
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{ccccccccc}
			...
			TR2            & P               & C1               & 2.160           & 32          & 28                 & 92{,}81             & 17{,}78      & 0{,}25              \\
...
\begin{table}[H]
	...
	\small
	\setlength{\tabcolsep}{3pt}
	\caption{Accesorios por tramo en la red de condensados y cálculo de longitudes equivalentes}
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{lccccccc}
			...
			P-S            & 105                            & 1                  & 0                  & 2                   & 65                                & 13,78                        & 118,78                            \\
			S-C$_2$        & 24                             & 0                  & 0                  & 0                   & ---                               & 4,8                          & 28,8                              \\
			S-T            & 60                             & 0                  & 1                  & 1                   & 50                                & 5,5                          & 65,5                              \\
			T-C$_3$        & 14                             & 0                  & 0                  & 0                   & ---                               & 2,8                          & 16,8                              \\
			T-C$_4$        & 44                             & 2                  & 1                  & 0                   & 50                                & 6,2                          & 50,2                              \\
			\bottomrule
		\end{tabular}
	}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{lcc}
		...
		\midrule
		Caldera $\rightarrow$ C1    & $0{,}02 + 0{,}25 = 0{,}27$                   & \checkmark      \\
...
\begin{itemize}[leftmargin=2em]
	...
	\item \textbf{3. Envolvente arena:} Arena de río lavada. Cota de $-0{,}90$~m a $-1{,}34$~m (espesor 0{,}44~m). Función: Lecho elástico, drenaje. Se subdivide en:
	      \begin{itemize}[leftmargin=2em]
		      \item \textbf{3a. Margen superior:} Arena lavada. Cota de $-0{,}90$~m a $-1{,}00$~m (espesor 0{,}10~m). Función: Zona de seguridad.
		      \item \textbf{3b. Zona de tuberías:} Arena + tuberías. Cota de $-1{,}00$~m a $-1{,}19$~m (espesor 0{,}19~m). Función: Alberga las tuberías (eje a $-1{,}09$~m).
		      \item \textbf{3c. Lecho de apoyo:} Arena nivelada. Cota de $-1{,}19$~m a $-1{,}34$~m (espesor 0{,}15~m). Función: Cama de apoyo (15~cm).
	      \end{itemize}
\end{itemize}
...
\begin{figure}[H]
	\centering
	\includegraphics[trim={4.5cm 3cm 3cm 2.4cm}, clip,width=\textwidth]{Figuras/esquema_enterramiento.pdf}
...
La caldera seleccionada, modelo Viessmann VITOMAX 100-HS M33A, proporciona un caudal de vapor de 5400 kg/h a 10 bar(a) y 220°C, con un margen del 6,3\% sobre el caudal de diseño calculado de 5078,4 kg/h. Este margen de reserva resulta suficiente para absorber variaciones de demanda sin sobredimensionar excesivamente la inversión. La presión de diseño de 9,068 bar(g), corregida por la altitud del emplazamiento a 700 m sobre el nivel del mar, garantiza presiones adecuadas en todos los puntos de consumo. La selección de vapor sobrecalentado a 220°C minimiza el riesgo de condensación prematura en los tramos de mayor longitud, especialmente en el tramo enterrado TR2 de 88,19 m, asegurando la calidad del vapor suministrado.

La red de distribución de vapor consta de 7 tramos con una longitud total de 351,93 m, dimensionados adoptando una velocidad objetivo de 20 m/s. Las velocidades reales obtenidas se sitúan en el rango 18,93--21,45 m/s, cumpliendo holgadamente con el criterio de velocidad máxima de 30 m/s y minimizando el riesgo de erosión en codos y accesorios. La pérdida de carga máxima acumulada en el camino más desfavorable es de 0,38 bar, muy inferior al límite de 1 bar establecido como criterio de diseño. Todos los puntos de consumo reciben vapor con presiones superiores a 8,69 bar(g), excediendo ampliamente las presiones requeridas de 4 bar(g) para el consumidor C1 y 7 bar(g) para los consumidores C$_2$, C$_3$ y C$_4$. El diseño combina tuberías normalizadas según DIN 2448 para los tramos de mayor diámetro y tuberías Schedule API para los tramos de menor diámetro, facilitando la adquisición de materiales y la ejecución de la obra.

La red de retorno de condensados, dimensionada para operar a 3 bar(g), presenta una longitud total de 321,61 m distribuidos en 7 tramos. El dimensionado de esta red reviste especial complejidad debido a la naturaleza bifásica del flujo, que incluye tanto condensado líquido como vapor flash generado por la expansión desde las condiciones de consumo. La expansión del condensado desde presiones entre 4 y 7 bar(g) hasta la presión del colector de 3 bar(g) genera 402,54 kg/h de vapor flash, representando el 7,45\% en masa del caudal total. Aunque esta fracción másica es reducida, el vapor flash domina el comportamiento hidráulico del sistema debido a su baja densidad, ocupando aproximadamente el 98\% del volumen total del flujo bifásico. Las velocidades obtenidas se sitúan en el rango 17,41--19,31 m/s, dentro del rango recomendado de 15--20 m/s para flujo bifásico, y la pérdida de carga máxima acumulada es de 0,30 bar, valor razonable que no compromete el retorno gravitatorio del condensado. El vapor flash generado, equivalente a aproximadamente 266 kW térmicos, constituye una oportunidad de mejora energética que podría aprovecharse mediante tanques separadores para precalentar el agua de alimentación de la caldera.

El sistema de aislamiento térmico ha sido dimensionado empleando lana de roca con conductividad térmica de 0,04 W/(m·K), adoptando una estrategia de estandarización por rangos de diámetro nominal para simplificar la especificación de materiales. Los espesores adoptados varían entre 60 y 100 mm para la red de vapor (según el rango de diámetro) y entre 40 y 50 mm para la red de condensados. Las pérdidas térmicas totales calculadas son de 30,81 kW, representando únicamente el 0,73\% de la potencia térmica nominal de la caldera de 4217 kW. Este valor se encuentra muy por debajo del límite recomendado del 2--3\% establecido por las guías de eficiencia energética del IDAE, validando la efectividad del diseño propuesto. La temperatura superficial del aislamiento en los tramos aéreos se sitúa en el rango 16,3--18,2°C, muy inferior al límite de 30°C establecido por el RITE, eliminando completamente el riesgo de quemaduras por contacto accidental.

El tramo enterrado TR2, que conecta el punto de bifurcación P con el consumidor C1, requiere consideraciones especiales tanto en el diseño constructivo como en el cálculo térmico. Con una longitud de 88,19 m para cada tubería (vapor y condensados), la profundidad del eje de tubería se ha establecido en 1,09 m, con una profundidad total de zanja de 1,34 m y un ancho de 1,50 m. La morfología de la zanja, de abajo hacia arriba, incluye una capa de arena de asiento de 10 cm, aislamiento térmico de lana de roca de 5 cm para vapor y 4 cm para condensados, envolvente de arena de relleno de 19 cm, losa de hormigón HA-25 de 10 cm de espesor para protección mecánica, y relleno de tierras compactadas de 80 cm. Las pérdidas térmicas del tramo enterrado totalizan 7,08 kW, representando el 23\% de las pérdidas totales de la instalación pese a constituir solo el 5,5\% de la longitud total. Esta concentración de pérdidas se debe al menor espesor de aislamiento aplicado, limitado por restricciones geométricas de la excavación, y al efecto del terreno como sumidero térmico adicional.
...
El diseño desarrollado cumple satisfactoriamente todos los criterios normativos establecidos en el RITE en cuanto a temperatura superficial, los criterios del IDAE sobre pérdidas térmicas máximas admisibles, los criterios hidráulicos recomendados por EREN y Spirax Sarco para velocidades y pérdidas de carga, y las especificaciones de tuberías comerciales normalizadas según DIN 2448 y Schedule API. Este cumplimiento normativo, junto con los amplios márgenes de seguridad mantenidos en parámetros críticos como presiones en consumidores y pérdidas de carga, garantiza la viabilidad técnica de la instalación propuesta y su conformidad con la reglamentación vigente en materia de instalaciones térmicas industriales.
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 1 de Vapor (Caldera-P). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 2 de Vapor (P-C1). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 3 de Vapor (P-S). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 4 de Vapor (S-C2). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 5 de Vapor (S-T). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 6 de Vapor (T-C3). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 7 de Vapor (T-C4). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 1 de Condensados (Caldera-P). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 2 de Condensados (P-C1). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 3 de Condensados (P-S). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 4 de Condensados (S-C2). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 5 de Condensados (S-T). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 6 de Condensados (T-C3). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Esquema del Tramo 7 de Condensados (T-C4). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 1 de Vapor (Caldera-P). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 2 de Vapor (P-C1). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 3 de Vapor (P-S). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 4 de Vapor (S-C2). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 5 de Vapor (S-T). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 6 de Vapor (T-C3). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 7 de Vapor (T-C4). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 1 de Condensados (Caldera-P). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 2 de Condensados (P-C1). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 3 de Condensados (P-S). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 4 de Condensados (S-C2). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 5 de Condensados (S-T). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 6 de Condensados (T-C3). Elaboración grupal.}
...
\begin{figure}[H]
	...
	\caption{Hoja de cálculo del Tramo 7 de Condensados (T-C4). Elaboración grupal.}
